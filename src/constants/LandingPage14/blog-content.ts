...
export const blogPosts: BlogPost[] = [
  {
    ...
    excerpt: "Are you developing a web application that uses webhooks? Do you need to test these webhooks but aren't sure how to do it on your local machine?",
    date: "2024-08-13",
  ...
  },
  {
    ...
    excerpt: "Welcome to this step-by-step guide on creating a blog generator using artificial intelligence! We'll be using Next.js, TypeScript, and OpenAI's GPT-4 ..",
    date: "2024-07-08",
