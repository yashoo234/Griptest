...
export const BlogCard = ({ post }: BlogCardProps) => {
  return (
    <div className='flex flex-col gap-3 p-4 pb-5 rounded-2xl border border-lp14-border bg-white shadow-md w-full max-w-[384px] text-left'>
      ...
      <p className='text-sm font-semibold text-[#BFBFBF] leading-relaxed'>{post.formattedDate}</p>
